...
const DEFAULT_WORKFLOW_PATH = 'n8n/facebook-crosspost.workflow.json';
...
async function main() {
  ...
  const workflowPath = path.resolve(process.cwd(), process.env.N8N_FACEBOOK_WORKFLOW_PATH || DEFAULT_WORKFLOW_PATH);
